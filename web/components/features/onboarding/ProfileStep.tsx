      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center gap-0">
            <span className="h-10 px-3 bg-slate-100 border border-r-0 border-slate-200 rounded-l-lg text-sm text-slate-500 flex items-center">
              masterminding.co/
            </span>
            <input
              {...register("slug")}
              className="flex-1 h-10 px-3 rounded-r-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#0F766E] focus:ring-offset-2"
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className="px-3 py-2.5 rounded-lg border border-slate-200 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-[#0F766E] focus:ring-offset-2"
          />
          {errors.bio && (
